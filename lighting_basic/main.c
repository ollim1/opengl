...
#include "geometry.h"
    ...
    shader_setVec3(lightingShader, "objectColor", objectColor);
    shader_setVec3(lightingShader, "lightColor", lightColor);
    shader_setVec3(lightingShader, "lightPos", lightPos);
